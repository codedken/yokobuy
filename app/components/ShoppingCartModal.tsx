                                ...
                                <>
                                    {Object.values(cartDetails ?? {}).map((entry) => (
                                        <li key={entry.id} className="flex py-6">
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col mr-6">
                                                <div className="mb-2">
                                                ...
                                                <div className="flex justify-between">
                                                    <QtyModBtn
                                                        ...
                                                        decrementQty={() => entry.quantity === 1 ? {} : addItem(entry, { count: -1 })}
                                                    />
                                                    <div className="flex">
                                                        <button
                                                            type="button"
                                                ...
                                                <div className="mt-2 flex flex-1 items-end justify-between text-sm">
                                                    ...
                                                    <p className="text-gray-500">Total: ${entry.quantity * entry.price}</p>
