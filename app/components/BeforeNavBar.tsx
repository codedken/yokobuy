    ...
    return (
        <div className="lg:flex hidden items-center justify-end w-full bg-black h-11 mx-auto px-44">
            <div className="flex items-center">
                <div className="flex items-center">
                    <p className={`${open ? "hidden" : ""}text-white text-sm font-light mr-8 whitespace-nowrap`}>
                        Need help?
                        <Link href="" className="underline ml-2 hover:text-primary hover:no-underline">Contact us on Whatsapp</Link>
                        <Link href="" className="underline ml-2 hover:text-primary hover:no-underline">or Contact Us</Link>
                    </p>
                    <input
                        type="text"
                ...
                <div className="flex gap-1.5">
                    <Link href="/login">
                        <Button variant={"outline"} className="bg-primary hover:bg-purple-700 rounded-none h-11 border-none">
                    ...
                    <Link href="/register">
                        <Button variant={"outline"} className="bg-red-600 hover:bg-red-700 rounded-none h-11 border-none">
                            <UserPlus2 className="mr-2 text-white" />
                            <span className="text-white text-xs tracking-wider">REGISTER</span>
                        </Button>
                    </Link>
